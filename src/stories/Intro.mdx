...
<div className="sb-container">
  <div className='sb-section-title'>
    ...
    This is where you'll find all the information and components you need to build consistent, beautiful products. Our Design System is a collection of design guidelines, reusable components, and resources that will help you efficiently create amazing interfaces.
  </div>
  <div className="sb-section">
    <div className="sb-section-item">
      ...
      />
      <h4 className="sb-section-item-heading">Reusable Components</h4>
      <p className="sb-section-item-paragraph">Explore a variety of ready-to-use interface components, from buttons to menus and navigation bars.</p>
    </div>
    <div className="sb-section-item">
      <Image 
        width={0}
      ...
      />
      <h4 className="sb-section-item-heading">Design Guidelines</h4>
      <p className="sb-section-item-paragraph">Discover design best practices like color palettes, typography, and usability principles that will ensure a consistent experience for users.</p>
    </div>
    <div className="sb-section-item">
      <Image 
        width={0}
      ...
      />
      <div>
        <h4 className="sb-section-item-heading">Examples and documentations</h4>
        <p className="sb-section-item-paragraph">TFind implementation examples and detailed documentation to make it easier to use Design System features.</p>
      </div>
    </div>
  </div>
</div>
